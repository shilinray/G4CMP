...
namespace RISQTutorialDetectorParameters
{
  ...
  constexpr double dp_siliconChipDimX = 20.0 * CLHEP::mm;
  constexpr double dp_siliconChipDimY = 20.0 * CLHEP::mm;
  ...
  constexpr double dp_useGroundPlane = false;
  ...
  constexpr bool dp_useTransmissionLine = false;
  ...
  constexpr bool dp_useFluxLines = false;
