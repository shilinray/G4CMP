...
private:
  ...
  G4CMPSurfaceProperty* fSiFeedInterface;
  G4CMPSurfaceProperty* fSiIndInterface;
  G4CMPSurfaceProperty* fSiCapInterface;
  G4CMPSurfaceProperty* fSiRightMountInterface;
  G4CMPSurfaceProperty* fSiLeftMountInterface;
