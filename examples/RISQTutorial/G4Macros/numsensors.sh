...
then
    ...
    then
        run_dir="./260419_run/SQUAT_Al_SW"
    elif [ "$pAbsProbSideWallSi" = "0.0" ]
    then
        run_dir="./260419_run/SQUAT_Al_PF"
    else
        run_dir="./260419_run/SQUAT_Al_wall_${pAbsProbSideWallSi}_polished_${pAbsProbPolishedWallSi}"
    fi
else
    if [ "$pAbsProbPolishedWallSi" = "0.0" ]
    then
        run_dir="./260419_run/SQUAT_Al_Nb_SW"
    elif [ "$pAbsProbSideWallSi" = "0.0" ]
    then
        run_dir="./260419_run/SQUAT_Al_Nb_PF"
    else
        run_dir="./260419_run/SQUAT_Al_Nb_wall_${pAbsProbSideWallSi}_polished_${pAbsProbPolishedWallSi}"
    fi
fi 
